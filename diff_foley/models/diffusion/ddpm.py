...
from diff_foley.util import log_txt_as_img, exists, default, ismap, isimage, mean_flat, count_params, instantiate_from_config
from diff_foley.modules.ema import LitEma
from diff_foley.models.distribution import normal_kl, DiagonalGaussianDistribution
from diff_foley.models.autoencoder import AutoencoderKL
from diff_foley.modules.diffusionmodules.util import make_beta_schedule, extract_into_tensor, noise_like
from diff_foley.models.diffusion.ddim import DDIMSampler


# Add Other Sampler:
from diff_foley.models.diffusion.plms import PLMSSampler
from diff_foley.models.diffusion.dpm_solver import DPMSolverSampler
...
class LatentDiffusion(DDPM):
    ...
    def decode_first_stage(self, z, predict_cids=False, force_not_quantize=False):
        ...
        if hasattr(self, "split_input_params"):
            ...
            # torch.save(output,"vaeoutput2.pt")
            return self.first_stage_model.decode(z)
